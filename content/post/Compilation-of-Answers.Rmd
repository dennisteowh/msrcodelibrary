...
If you have little experience with for loops and if else statements, please at least attempt to solve this problem on your own. If you know nothing about these functions, you can learn about them here.  
...
That said, there were some suggestions I gave student A for this code. You can see that student A used a similar looking code 3 different times, one for each question. When you are repeating code like that, that is a good sign to use a for loop whose main purpose is to repeat code.  
...
px1.check <- mean(c(17.80775, 23.89103, 24.90232))
...
px9.check <- mean(c(28.11434 ))

px9.check

data[9, "average.correct.time"]
